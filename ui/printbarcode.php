              ...
              <form class="form-horizontal" method="post" action="barcode/barcode.php" target="_blank">
                ...
                $select = $pdo->prepare("
                  SELECT
                      ...
                      Product_Stock.stock, Product_Stock.purchaseprice, Product_Stock.retailsaleprice, Product_Stock.wholesaleprice
                  FROM Product
...
<div class="row">
  <div class="col-md-12">
    <ul class="list-group col-md-7">
      ...
      <div class="form-group  pb-2">
        <label class="control-label" for="rate">Retail Price</label>
        <div class="col-sm-12">
          <input autocomplete="OFF" type="text" class="form-control" value="' . $row->retailsaleprice . '" id="retailsaleprice"
                 name="retailsaleprice" readonly>
        </div>
                 <br>   
        <div class="form-group  pb-2">
        <label class="control-label" for="rate">Wholesale Price</label>
        <div class="col-sm-12">
          <input autocomplete="OFF" type="text" class="form-control" value="' . $row->wholesaleprice . '" id="wholesaleprice"
                 name="wholesaleprice" readonly>
        </div>
