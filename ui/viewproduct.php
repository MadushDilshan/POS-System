        ...
        <div class="col-lg-12">
          ...
          <div class="card card-info card-outline">
            ...
            <div class="card-body">
              ...
              $select = $pdo->prepare("SELECT Product.*, Product_Stock.stock, Product_Stock.purchaseprice, Product_Stock.retailsaleprice, Product_Stock.wholesaleprice, Category.category
                         FROM Product
...
<div class="row">
  <div class="col-md-7">
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item"><b>Retail Sale Price</b> <span
          class="badge badge-dark float-right">' . $row->retailsaleprice . '</span></li>
      <li class="list-group-item"><b>Product Profit</b> <span class="badge badge-success float-right">' . ($row->retailsaleprice - $row->purchaseprice) . '</span>
      </li>

      <li class="list-group-item"><b>Whole Sale Price</b> <span
      class="badge badge-dark float-right">' . $row->wholesaleprice . '</span></li>
  <li class="list-group-item"><b>Product Profit</b> <span class="badge badge-success float-right">' . ($row->wholesaleprice - $row->purchaseprice) . '</span>
  </li>
