...
$select = $pdo->prepare("
    SELECT
        ...
        Product_Stock.retailsaleprice,
        Product_Stock.wholesaleprice
    FROM Product
...
$retailsaleprice_db = $row['retailsaleprice'];
$wholesaleprice_db = $row['wholesaleprice'];

if (isset($_POST['btneditproduct'])) {
  $retailsaleprice_txt = $_POST['txtretailsaleprice'];
  $wholesaleprice_txt = $_POST['txtwholesaleprice'];
  if ($purchaseprice_db > $retailsaleprice_txt) {
    ...
    try {
      ...
      $updateStock = $pdo->prepare("UPDATE Product_Stock SET retailsaleprice=:retailsaleprice, wholesaleprice=:wholesaleprice WHERE id=:stock_id");

      // Bind the parameters
      $updateStock->bindParam(':retailsaleprice', $retailsaleprice_txt);
      $updateStock->bindParam(':wholesaleprice', $wholesaleprice_txt);
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" min="1" step="any"
                             class="form-control"
                             value="<?php echo $retailsaleprice_db; ?>" placeholder="Enter Retail Selling Price" name="txtretailsaleprice"
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" min="1" step="any"
                             class="form-control"
                             value="<?php echo $wholesaleprice_db; ?>" placeholder="Enter Whole Selling Price" name="txtwholesaleprice"
                             autocomplete="off" required autofocus onfocus="this.select()">
