            ...
            <div class="card-body">
              ...
              <table class="table table-hover " id="table_product">
                ...
                <tr style="font-weight: bold">
                  ...
                  <td>Stock</td>
                  <td>PurchasePrice</td>
                  <td>Retail SalePrice</td>
                  <td>Whole SalePrice</td>
                  <td>ActionIcons</td>
                ...
                $select = $pdo->prepare("
                  SELECT
                      ...
                      ProductStock.retailsaleprice,
                      ProductStock.wholesaleprice
                  FROM Product
                ...
                if ($rows) {
                  ...
                  foreach ($groupedData as $barcode => $data) {
                    ...
                    foreach ($data as $item) {
                      ...
                      echo '<td>' . $item->retailsaleprice . '</td>';
                      echo '<td>' . $item->wholesaleprice . '</td>';
                      echo '<td>';
  ...
  function populateTable(groupedData) {
    ...
    for (let barcode in groupedData) {
      ...
      data.forEach(function (item) {
        ...
        tr.append('<td>' + item.retailsaleprice + '</td>');
        tr.append('<td>' + item.wholesaleprice + '</td>');
