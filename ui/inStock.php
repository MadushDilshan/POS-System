        ...
        <div class="col-lg-12">
          ...
          $select = $pdo->prepare("
                        SELECT
                            ...
                            IncomingStock.retailsaleprice,
                            IncomingStock.wholesaleprice,
          ...
          foreach ($groupedByDate as $date => $products) {
            ...
            foreach ($products as $product) {
              ...
              echo '<td>' . htmlspecialchars($product->retailsaleprice) . '</td>';
              echo '<td>' . htmlspecialchars($product->wholesaleprice) . '</td>';
              echo '</tr>';
            }
            echo '</tbody>';
            echo '</table>';
